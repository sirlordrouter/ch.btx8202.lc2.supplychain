 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://service/}preparedMedication" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetPreparedMedicationsForPatientResponse {
    ...
    protected List<PreparedMedication> _return;
     ...
     * 
     */
    public List<PreparedMedication> getReturn() {
        if (_return == null) {
            _return = new ArrayList<PreparedMedication>();
        }
        return this._return;
    }

...
public class Substance  implements java.io.Serializable {
    private webservice.hospindex.SubstanceSB[] SB;

    private webservice.hospindex.SubstanceRESULT RESULT;
    ...
    public Substance(
           webservice.hospindex.SubstanceSB[] SB,
           webservice.hospindex.SubstanceRESULT RESULT,
    ...
    /**
     * Gets the SB value for this Substance.
     * 
     * @return SB
     */
    public webservice.hospindex.SubstanceSB[] getSB() {
        return SB;
    }


    /**
     * Sets the SB value for this Substance.
     * 
     * @param SB
     */
    public void setSB(webservice.hospindex.SubstanceSB[] SB) {
        this.SB = SB;
    }

    public webservice.hospindex.SubstanceSB getSB(int i) {
        return this.SB[i];
    }

    public void setSB(int i, webservice.hospindex.SubstanceSB _value) {
        this.SB[i] = _value;
    }


    /**
     * Gets the RESULT value for this Substance.
     * 
     * @return RESULT
     */
    public webservice.hospindex.SubstanceRESULT getRESULT() {
        return RESULT;
    }


    /**
     * Sets the RESULT value for this Substance.
     * 
     * @param RESULT
     */
    public void setRESULT(webservice.hospindex.SubstanceRESULT RESULT) {
        this.RESULT = RESULT;
    }


    /**
     * Gets the CREATION_DATETIME value for this Substance.
     * 
    ...
    /**
     * Sets the CREATION_DATETIME value for this Substance.
     * 
    ...
    /**
     * Gets the PROD_DATE value for this Substance.
     * 
     * @return PROD_DATE
     */
    ...
    /**
     * Sets the PROD_DATE value for this Substance.
     * 
     * @param PROD_DATE
     */
    ...
    /**
     * Gets the VALID_DATE value for this Substance.
     * 
     * @return VALID_DATE
     */
    ...
    /**
     * Sets the VALID_DATE value for this Substance.
     * 
     * @param VALID_DATE
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            ((this.SB==null && other.getSB()==null) || 
             (this.SB!=null &&
              java.util.Arrays.equals(this.SB, other.getSB()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getSB() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSB());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSB(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(Substance.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", ">Substance"));
        ...
        elemField.setFieldName("SB");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", "SB"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", ">>Substance>SB"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", ">>Substance>RESULT"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }

...
public class Insurance  implements java.io.Serializable {
    private webservice.hospindex.InsuranceINS[] INS;

    private webservice.hospindex.InsuranceRESULT RESULT;
    ...
    public Insurance(
           webservice.hospindex.InsuranceINS[] INS,
           webservice.hospindex.InsuranceRESULT RESULT,
    ...
    /**
     * Gets the INS value for this Insurance.
     * 
     * @return INS
     */
    public webservice.hospindex.InsuranceINS[] getINS() {
        return INS;
    }


    /**
     * Sets the INS value for this Insurance.
     * 
     * @param INS
     */
    public void setINS(webservice.hospindex.InsuranceINS[] INS) {
        this.INS = INS;
    }

    public webservice.hospindex.InsuranceINS getINS(int i) {
        return this.INS[i];
    }

    public void setINS(int i, webservice.hospindex.InsuranceINS _value) {
        this.INS[i] = _value;
    }


    /**
     * Gets the RESULT value for this Insurance.
     * 
     * @return RESULT
     */
    public webservice.hospindex.InsuranceRESULT getRESULT() {
        return RESULT;
    }


    /**
     * Sets the RESULT value for this Insurance.
     * 
     * @param RESULT
     */
    public void setRESULT(webservice.hospindex.InsuranceRESULT RESULT) {
        this.RESULT = RESULT;
    }


    /**
     * Gets the CREATION_DATETIME value for this Insurance.
     * 
    ...
    /**
     * Sets the CREATION_DATETIME value for this Insurance.
     * 
    ...
    /**
     * Gets the PROD_DATE value for this Insurance.
     * 
     * @return PROD_DATE
     */
    ...
    /**
     * Sets the PROD_DATE value for this Insurance.
     * 
     * @param PROD_DATE
     */
    ...
    /**
     * Gets the VALID_DATE value for this Insurance.
     * 
     * @return VALID_DATE
     */
    ...
    /**
     * Sets the VALID_DATE value for this Insurance.
     * 
     * @param VALID_DATE
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        boolean _equals;
        _equals = true && 
            ((this.INS==null && other.getINS()==null) || 
             (this.INS!=null &&
              java.util.Arrays.equals(this.INS, other.getINS()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getINS() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getINS());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getINS(), i);
                if (obj != null &&
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", ">Insurance"));
        ...
        elemField.setFieldName("INS");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", "INS"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", ">>Insurance>INS"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", ">>Insurance>RESULT"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }

...
public class ServiceProvider  implements java.io.Serializable {
    private webservice.hospindex.ServiceProviderSP[] SP;

    private webservice.hospindex.ServiceProviderRESULT RESULT;
    ...
    public ServiceProvider(
           webservice.hospindex.ServiceProviderSP[] SP,
           webservice.hospindex.ServiceProviderRESULT RESULT,
    ...
    /**
     * Gets the SP value for this ServiceProvider.
     * 
     * @return SP
     */
    public webservice.hospindex.ServiceProviderSP[] getSP() {
        return SP;
    }


    /**
     * Sets the SP value for this ServiceProvider.
     * 
     * @param SP
     */
    public void setSP(webservice.hospindex.ServiceProviderSP[] SP) {
        this.SP = SP;
    }

    public webservice.hospindex.ServiceProviderSP getSP(int i) {
        return this.SP[i];
    }

    public void setSP(int i, webservice.hospindex.ServiceProviderSP _value) {
        this.SP[i] = _value;
    }


    /**
     * Gets the RESULT value for this ServiceProvider.
     * 
     * @return RESULT
     */
    public webservice.hospindex.ServiceProviderRESULT getRESULT() {
        return RESULT;
    }


    /**
     * Sets the RESULT value for this ServiceProvider.
     * 
     * @param RESULT
     */
    public void setRESULT(webservice.hospindex.ServiceProviderRESULT RESULT) {
        this.RESULT = RESULT;
    }


    /**
     * Gets the CREATION_DATETIME value for this ServiceProvider.
     * 
    ...
    /**
     * Sets the CREATION_DATETIME value for this ServiceProvider.
     * 
    ...
    /**
     * Gets the PROD_DATE value for this ServiceProvider.
     * 
     * @return PROD_DATE
     */
    ...
    /**
     * Sets the PROD_DATE value for this ServiceProvider.
     * 
     * @param PROD_DATE
     */
    ...
    /**
     * Gets the VALID_DATE value for this ServiceProvider.
     * 
     * @return VALID_DATE
     */
    ...
    /**
     * Sets the VALID_DATE value for this ServiceProvider.
     * 
     * @param VALID_DATE
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ((this.SP==null && other.getSP()==null) || 
             (this.SP!=null &&
              java.util.Arrays.equals(this.SP, other.getSP()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getSP() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSP());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSP(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ServiceProvider.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", ">ServiceProvider"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", "SP"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", ">>ServiceProvider>SP"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", ">>ServiceProvider>RESULT"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }

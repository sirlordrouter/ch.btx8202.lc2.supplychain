...
public class ProductRESULT  implements java.io.Serializable {
    private webservice.hospindex.ProductRESULTOK_ERROR OK_ERROR;
    ...
    public ProductRESULT(
           webservice.hospindex.ProductRESULTOK_ERROR OK_ERROR,
    ...
    /**
     * Gets the OK_ERROR value for this ProductRESULT.
     * 
     * @return OK_ERROR
     */
    public webservice.hospindex.ProductRESULTOK_ERROR getOK_ERROR() {
        return OK_ERROR;
    }


    /**
     * Sets the OK_ERROR value for this ProductRESULT.
     * 
     * @param OK_ERROR
     */
    public void setOK_ERROR(webservice.hospindex.ProductRESULTOK_ERROR OK_ERROR) {
        this.OK_ERROR = OK_ERROR;
    }


    /**
     * Gets the NBR_RECORD value for this ProductRESULT.
     * 
     * @return NBR_RECORD
     */
    ...
    /**
     * Sets the NBR_RECORD value for this ProductRESULT.
     * 
     * @param NBR_RECORD
     */
    ...
    /**
     * Gets the ERROR_CODE value for this ProductRESULT.
     * 
     * @return ERROR_CODE
     */
    ...
    /**
     * Sets the ERROR_CODE value for this ProductRESULT.
     * 
     * @param ERROR_CODE
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", ">>Product>RESULT"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", ">>>Product>RESULT>OK_ERROR"));

...
public class InteractionRESULT  implements java.io.Serializable {
    private webservice.hospindex.InteractionRESULTOK_ERROR OK_ERROR;
    ...
    public InteractionRESULT(
           webservice.hospindex.InteractionRESULTOK_ERROR OK_ERROR,
    ...
    /**
     * Gets the OK_ERROR value for this InteractionRESULT.
     * 
     * @return OK_ERROR
     */
    public webservice.hospindex.InteractionRESULTOK_ERROR getOK_ERROR() {
        return OK_ERROR;
    }


    /**
     * Sets the OK_ERROR value for this InteractionRESULT.
     * 
     * @param OK_ERROR
     */
    public void setOK_ERROR(webservice.hospindex.InteractionRESULTOK_ERROR OK_ERROR) {
        this.OK_ERROR = OK_ERROR;
    }


    /**
     * Gets the NBR_RECORD value for this InteractionRESULT.
     * 
     * @return NBR_RECORD
     */
    ...
    /**
     * Sets the NBR_RECORD value for this InteractionRESULT.
     * 
     * @param NBR_RECORD
     */
    ...
    /**
     * Gets the ERROR_CODE value for this InteractionRESULT.
     * 
     * @return ERROR_CODE
     */
    ...
    /**
     * Sets the ERROR_CODE value for this InteractionRESULT.
     * 
     * @param ERROR_CODE
     */
    ...
    /**
     * Gets the MESSAGE value for this InteractionRESULT.
     * 
     * @return MESSAGE
     */
    ...
    /**
     * Sets the MESSAGE value for this InteractionRESULT.
     * 
     * @param MESSAGE
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", ">>Interaction>RESULT"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.e-mediat.ch/index", ">>>Interaction>RESULT>OK_ERROR"));
